          ...
          <div class="row justify-content-center">
            <div class="col-lg-7">
              <div class="card shadow-lg border-0 rounded-lg mt-5">
                ...
                <div class="card-body">
                  <form method="post" action="<?= base_url('C_alangAuth/register') ?>">
                    <div class="row mb-3">
                      <div class="col-md-6">
                        <div class="form-floating mb-3 mb-md-0">
                          <input class="form-control" id="nama_petugas" name="nama_petugas" type="text" placeholder="Enter your first name" />
                ...
                <div class="card-footer text-center py-3">
                  <div class="small"><a href="<?= base_url('C_alangAuth') ?>">Have an account? Go to
                      login</a></div>
                </div>
              </div>
            </div>
