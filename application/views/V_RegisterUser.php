            ...
            <div class="col-lg-7">
              <div class="card shadow-lg border-0 rounded-lg mt-5">
                <div class="card-header">
                  <h3 class="text-center font-weight-light my-4">Create Account User</h3>
                </div>
                <div class="card-body">
                  <form method="post" action="<?= base_url('C_alangAuth/registeruser') ?>">
                    <div class="row mb-3">
                      <div class="col-md-6">
                    ...
                    <div class="form-floating mb-3">
                      <input class="form-control" id="nik" name="nik" type="number" placeholder="name@example.com" />
                      <label for="inputEmail">NIK</label>
                    </div>
                    <div class="form-floating mb-3">
                      <input class="form-control" id="telepon" name="telepon" type="number" placeholder="name@example.com" />
                    ...
                    <button type="submit" class="btn btn-primary btn-block col-md-12">Create Account</button>
                  </form>
                </div>
                <div class="card-footer text-center py-3">
                  <div class="small"><a href="<?= base_url('C_alangAuth/loginuser') ?>">Have an account? Go to
                      login</a></div>
                </div>
              </div>
            </div>
